...
import 'package:news_api_app/Controller/CategoryModelController.dart';
import 'package:news_api_app/View/Screens/DetailsNewsScreen.dart';

class CategoryNewsPage extends StatefulWidget {
  String categoryName;

  CategoryNewsPage({super.key, required this.categoryName});
...
class _CategorynewspageState extends State<CategoryNewsPage> {
  CategoryModelController categoryModelController =
      Get.put(CategoryModelController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: categoryModelController.fetchCategorydata(widget.categoryName),
        builder: (context, snapshot) {
          ...
          return Obx(
            () {
              var newsModelData = categoryModelController.categoryList;
